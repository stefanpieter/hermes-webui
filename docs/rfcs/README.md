...
- [`exact-persisted-message-replay-guard.md`](exact-persisted-message-replay-guard.md)
  — proposed persistence-boundary invariant that removes only byte-equivalent
  replay rows carrying stable event identity before a session save.
